...
|---|---|---|---|
| Wolf, Angerer, Theis. Scanpy: large-scale single-cell gene expression data analysis. Genome Biology 19, 15 (2018). DOI: 10.1186/s13059-017-1382-0 | Verified | PubMed, Springer/Genome Biology, Scanpy docs references | Supports use of Scanpy for preprocessing, visualization, clustering and scalable single-cell analysis. |
| Palla et al. Squidpy: a scalable framework for spatial omics analysis. Nature Methods 19, 171-178 (2022). DOI: 10.1038/s41592-021-01358-2 | Verified | Nature Methods, PubMed, Squidpy docs references | Supports Squidpy spatial graph/statistics/image workflow framing. |
...
| Orchestrating Spatial Transcriptomics Analysis with Bioconductor (OSTA) | Verified | Bioconductor book site | Supports the standard workflow framing: data structure, QC, intermediate processing and downstream spatial analysis. |
...
| NCBI GEO GSE278603 | Verified | NCBI GEO accession viewer | Public on 2025-06-19; contains six mouse embryo samples including `GSM9046244 embryo E7.5 rep2`; supplementary archive is `GSE278603_RAW.tar` containing H5AD resources. GEO page currently displays "Citation missing", so the report treats the Cell paper as the corresponding research background rather than claiming GEO has already linked the citation. |
| Xie, Shen, Yang et al. Digital reconstruction of full embryos during early mouse organogenesis. Cell (2025). DOI: 10.1016/j.cell.2025.05.035 | Verified | Cell Press / DOI search / PubMed search result / Nature Index metadata | Supports the biological background for the digital embryo dataset and the presentation narrative. |
